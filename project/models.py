...
class ProjectStage(ClockoModel):
    """
    ProjectStage model
    """
    ...
    objects = ClockoCompanyManager("project__company_id")
...
class TimeSheet(ClockoModel):
    ...
    objects = ClockoCompanyManager("project_id__company_id")
