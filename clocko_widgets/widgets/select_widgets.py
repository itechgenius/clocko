...
This module is used to write Clocko form select widgets
"""
...
class ClockoMultiSelectWidget(forms.Widget):
    """
    ClockoMultiSelectWidget
    """
    ...
    template_name = "Clocko_widgets/Clocko_multiselect_widget.html"
