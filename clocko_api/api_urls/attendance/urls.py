"""
Clocko_api/urls/attendance/urls.py
"""

from django.urls import path

from Clocko_api.api_views.attendance.permission_views import AttendancePermissionCheck
from Clocko_api.api_views.attendance.views import *
