"""
Clocko_automation/views/views.py
"""
...
from Clocko_automations.methods.serialize import serialize_form
from Clocko_automations.models import MailAutomation
from Clocko_automations.signals import REFRESH_METHODS
...
@login_required
@permission_required("Clocko_automations.delete_mailautomation")
...
@login_required
@permission_required("Clocko_automations.add_mailautomation")
