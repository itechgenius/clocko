"""
Clocko_automations/views/cbvs.py
"""
...
from base.models import ClockoMailTemplate
from Clocko.decorators import login_required, permission_required
from Clocko_automations import models
from Clocko_automations.filters import AutomationFilter
from Clocko_automations.forms import AutomationForm
from Clocko_views.generic.cbv import views


@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("Clocko_automations.view_mailautomation"), name="dispatch"
)
class AutomationSectionView(views.ClockoSectionView):
    """
    ...
    template_name = "Clocko_automations/section_view.html"
...
class AutomationNavView(views.ClockoNavView):
    """
    AutomationNavView
    """
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.actions = []
        if self.request.user.has_perm("Clocko_automations.add_mailautomation"):
            self.create_attrs = f"""
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("Clocko_automations.change_mailautomation"), name="dispatch"
)
class AutomationFormView(views.ClockoFormView):
    """
    AutomationFormView
    """
    ...
    template_name = "Clocko_automations/automation_form.html"
...
class AutomationListView(views.ClockoListView):
    """
    AutomationListView
    """
...
class AutomationDetailedView(views.ClockoDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("Clocko_automations.add_mailautomation"), name="dispatch"
)
class LoadAutomationsView(View):
    template_name = "Clocko_automations/load_automation.html"
    ...
    def post(self, request):
        ...
        for template_json in templates_raw:
            if template_json["pk"] in required_template_pks:
                ...
                existing = ClockoMailTemplate.objects.filter(
        ...
        for automation_json in selected_automations:
            ...
            mail_template = ClockoMailTemplate.objects.filter(
                body=template_body
            ).first()
