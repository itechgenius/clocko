...
from Clocko.signals import post_bulk_update, pre_bulk_update
...
def start_automation():
    ...
    @receiver(post_delete, sender=ClockoMailTemplate)
    @receiver(post_save, sender=ClockoMailTemplate)
...
def send_automated_mail(
    ...
    from Clocko_automations.methods.methods import evaluate_condition, operator_map
...
def send_mail(request, automation, instance):
    ...
    from Clocko_automations.methods.methods import (
        get_model_class,
