...
from Clocko_automations.methods.methods import generate_choices
from Clocko_automations.models import MODEL_CHOICES, MailAutomation
...
class AutomationForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # --- Field: also_sent_to ---
        self.fields["also_sent_to"] = ClockoMultiSelectField(
    ...
    def clean(self):
        ...
        if isinstance(self.fields["also_sent_to"], ClockoMultiSelectField):
