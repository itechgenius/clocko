"""
App configuration for the Clocko Automations app.
...
class ClockoAutomationConfig(AppConfig):
    """Configuration class for the Clocko Automations Django app."""

    default_auto_field = "django.db.models.BigAutoField"
    name = "Clocko_automations"
    ...
    def ready(self) -> None:
        ...
        try:
            ...
            from base.templatetags.Clockofilters import app_installed
            from employee.models import Employee
            from Clocko_automations.methods.methods import get_related_models
            from Clocko_automations.models import MODEL_CHOICES
            ...
            try:
                from Clocko_automations.signals import start_automation
