...
import Clocko.Clocko_settings


class ClockoLdapConfig(AppConfig):
    ...
    def ready(self):
        ...
        APPS.append("Clocko_ldap")
        urlpatterns.append(
            path("", include("Clocko_ldap.urls")),
        )
        super().ready()

        ldap_config = Clocko.Clocko_settings.load_ldap_settings()
