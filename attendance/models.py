...
class AttendanceActivity(ClockoModel):
    """
...
class BatchAttendance(ClockoModel):
    """
...
class AttendanceRequestFile(ClockoModel):
    file = models.FileField(upload_to=upload_path)


class AttendanceRequestComment(ClockoModel):
    """
...
class AttendanceOverTime(ClockoModel):
    """
...
class AttendanceLateComeEarlyOut(ClockoModel):
    """
...
class AttendanceValidationCondition(ClockoModel):
    """
...
class AttendanceGeneralSetting(ClockoModel):
    """
