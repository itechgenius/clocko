"""
This module provides Clocko ModelForms for creating and managing leave-related data,
...
from Clocko_widgets.forms import ClockoForm, ClockoModelForm
...
class LeaveTypeAdminForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if f := self.fields.get("company_id"):
            from Clocko_widgets.forms import default_select_option_template
...
class LeaveTypeForm(ConditionForm):
    ...
    employee_id = ClockoMultiSelectField(
...
class LeaveOneAssignForm(ClockoModelForm):
    """
    ...
    Attributes:
        - employee_id: A ClockoMultiSelectField representing the employee to assign leave to.
    """
...
class AssignLeaveForm(ClockoForm):
    """
    Form for Payslip
    """
