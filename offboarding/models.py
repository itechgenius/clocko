...
class OffboardingStage(ClockoModel):
    """
    Offboarding model
    """
...
class OffboardingStageMultipleFile(ClockoModel):
    """
...
class OffboardingEmployee(ClockoModel):
    """
...
class ResignationLetter(ClockoModel):
    """
...
class OffboardingTask(ClockoModel):
    """
...
class EmployeeTask(ClockoModel):
    """
    EmployeeTask model
    """
...
class OffboardingNote(ClockoModel):
    """
    OffboardingNote
    """
...
class OffboardingGeneralSetting(ClockoModel):
    """
