...
class SurveyTemplate(ClockoModel):
    """
...
class Stage(ClockoModel):
    ...
    objects = ClockoCompanyManager(related_company_field="recruitment_id__company_id")
...
class RejectReason(ClockoModel):
    """
    RejectReason
    """
...
class RejectedCandidate(ClockoModel):
    """
    RejectedCandidate
    """
...
class RecruitmentSurvey(ClockoModel):
    """
    ...
    objects = ClockoCompanyManager(related_company_field="recruitment_ids__company_id")
...
class QuestionOrdering(ClockoModel):
    """
...
class RecruitmentSurveyAnswer(ClockoModel):
    """
...
class SkillZoneCandidate(ClockoModel):
    """
...
class CandidateRating(ClockoModel):
...
class RecruitmentGeneralSetting(ClockoModel):
    """
...
class InterviewSchedule(ClockoModel):
    """
    ...
    objects = ClockoCompanyManager("candidate_id__recruitment_id__company_id")
...
class CandidateDocumentRequest(ClockoModel):
    title = models.CharField(max_length=100)
...
class CandidateDocument(ClockoModel):
...
class LinkedInAccount(ClockoModel):
