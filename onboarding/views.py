...
from base.models import ClockoMailTemplate, JobPosition
...
def candidates_view(request):
    ...
    mail_templates = ClockoMailTemplate.objects.all()
...
def email_send(request):
    ...
    bodys = list(
        ClockoMailTemplate.objects.filter(id__in=template_attachment_ids).values_list(
            "body", flat=True
        )
    )
