...
from Clocko.signals import post_generic_delete, pre_generic_delete
from Clocko_views import models
from Clocko_views.cbv_methods import get_short_uuid, login_required, merge_dicts
from Clocko_views.forms import SavedFilterForm
from Clocko_views.generic.cbv.views import ClockoFormView, ClockoListView
...
class ReloadField(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        model: models.ClockoModel = dynamic_cache["model"]
...
@method_decorator(login_required, name="dispatch")
class SavedFilter(ClockoFormView):
    """
    SavedFilter
    """
...
class DynamiListView(ClockoListView):
    """
...
class ClockoDeleteConfirmationView(View):
    """
