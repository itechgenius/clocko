"""
Clocko_views/urls.py
"""

from django.urls import path

from Clocko_views import views
from Clocko_views.generic.cbv import history
from Clocko_views.generic.cbv.views import ReloadMessages
...
urlpatterns = [
    ...
    path(
        "generic-delete",
        views.ClockoDeleteConfirmationView.as_view(),
        name="generic-delete",
    ),
    path(
        "Clocko-history-revert/<int:pk>/<int:history_id>/",
        history.ClockoHistoryView.as_view(),
        name="history-revert",
    ),
]
