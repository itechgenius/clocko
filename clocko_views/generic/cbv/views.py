...
from Clocko.signals import post_generic_import, pre_generic_import
from Clocko_views import models
from Clocko_views.cbv_methods import (  # update_initial_cache,
    assign_related,
    export_xlsx,
...
from Clocko_views.forms import DynamicBulkUpdateForm, ToggleColumnForm
...
class ClockoListView(ListView):
    ...
    template_name: str = "generic/Clocko_list_table.html"
    ...
    def serve_import_sheet(self, request, *args, **kwargs):
        ...
        if not self.import_accessibility():
            ...
            return ClockoFormView.HttpResponse()
    ...
    def get_context_data(self, **kwargs: Any):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[ClockoListView] = context
        from Clocko.urls import path, urlpatterns
    ...
    def export_data(self, *args, **kwargs):
        ...
        class ClockoListViewResorce(resources.ModelResource):
            """
        ...
        book_resource = ClockoListViewResorce()
...
class ClockoSectionView(TemplateView):
    """
    Clocko Template View
    """
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, ClockoListView)
    ...
    template_name = "generic/Clocko_section.html"
...
class ClockoDetailedView(DetailView):
    ...
    title = "Detailed View"
    template_name = "generic/Clocko_detailed_view.html"
    header: dict = {
        "title": "Clocko",
        "subtitle": "Clocko Detailed View",
        "avatar": "",
    }
    body: list = []
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, ClockoDetailedView)
...
@method_decorator(hx_request_required, name="dispatch")
class ClockoTabView(TemplateView):
    """
    ClockoTabView
    """

    view_id: str = get_short_uuid(3, "htv")
    template_name = "generic/Clocko_tabs.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.request = request
        self.query_params = {}
        # update_initial_cache(request, CACHE, ClockoTabView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[ClockoTabView] = context

        return context


@method_decorator(hx_request_required, name="dispatch")
class ClockoCardView(ListView):
    """
    ClockoCardView
    """
    ...
    template_name = "generic/Clocko_card.html"
    context_object_name = "queryset"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, ClockoCardView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[ClockoCardView] = context
        referrer = self.request.GET.get("referrer", "")
        if referrer:
            # Remove the protocol and domain part
            referrer = "/" + "/".join(referrer.split("/")[3:])
...
class ClockoFormView(FormView):
    ...
    template_name = "generic/Clocko_form.html"
    ids_key: str = "instance_ids"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        # update_initial_cache(request, CACHE, ClockoFormView)
    ...
    def get_form(self, form_class=None):
        ...
        if not hasattr(self, "form"):
            ...
            if self.request.method == "GET":
                ...
                for dynamic_tuple in self.dynamic_create_fields:
                    ...
                    form.fields[field].widget.option_template_name = (
                        "Clocko_widgets/select_option.html",
                    )
            ...
            # CACHE.get(self.request.session.session_key + "cbv")[ClockoFormView] = form
            self.form = form
        return self.form
...
@method_decorator(hx_request_required, name="dispatch")
class ClockoNavView(TemplateView):
    """
    ClockoNavView
    ...
    template_name = "generic/Clocko_nav.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, ClockoNavView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[ClockoNavView] = context
        return context
...
@method_decorator(hx_request_required, name="dispatch")
class ClockoProfileView(DetailView):
    """
    GenericClockoProfileView
    """

    template_name = "generic/Clocko_profile_view.html"
    view_id: str = None
    filter_class: FilterSet = None
    push_url: str = None
    key_name: str = "pk"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.request = request
        self.ordered_ids_key = f"ordered_ids_{self.model.__name__.lower()}"
        # update_initial_cache(request, CACHE, ClockoProfileView)
