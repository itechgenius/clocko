"""
Clocko_views/generic/cbv/history.py
"""
...
from Clocko_views.cbv_methods import hx_request_required
from Clocko_views.generic.cbv.views import ClockoFormView
from Clocko_views.history_methods import get_diff


@method_decorator(hx_request_required, name="dispatch")
class ClockoHistoryView(DetailView):
    """
    GenericClockoProfileView
    """

    template_name = "generic/Clocko_history_view.html"
