...
from Clocko.Clocko_apps import NESTED_SUBORDINATE_VISIBILITY
from Clocko.Clocko_middlewares import _thread_locals
from Clocko.Clocko_settings import Clocko_DATE_FORMATS, Clocko_TIME_FORMATS
...
def format_export_value(value, employee):
    ...
    if isinstance(value, time):
        ...
        for format_name, format_string in Clocko_TIME_FORMATS.items():
