...
from Clocko_audit.models import AuditTag
...
class AssignPermission(Form):
    ...
    employee = ClockoMultiSelectField(
...
class JobPositionMultiForm(ModelForm):
    ...
    department_id = ClockoMultiSelectField(
...
class AnnouncementForm(ModelForm):
    ...
    employees = ClockoMultiSelectField(
        queryset=Employee.objects.all(),
        widget=ClockoMultiSelectWidget(
            filter_route_name="employee-widget-filter",
            filter_class=EmployeeFilter,
    ...
    def clean(self):
        ...
        if isinstance(self.fields["employees"], ClockoMultiSelectField):
...
class PenaltyAccountForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if apps.is_installed("leave") and employee:
            LeaveType = get_Clocko_model_class(app_label="leave", model="leavetype")
