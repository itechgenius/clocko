...
class JobPosition(ClockoModel):
    ...
    objects = ClockoCompanyManager("department_id__company_id")
...
class JobRole(ClockoModel):
    ...
    objects = ClockoCompanyManager("job_position_id__department_id__company_id")
...
class RotatingWorkType(ClockoModel):
    """
    ...
    objects = ClockoCompanyManager("employee_id__employee_work_info__company_id")
...
class RotatingWorkTypeAssign(ClockoModel):
    """
...
class EmployeeType(ClockoModel):
    """
    EmployeeType model
    """
...
class EmployeeShift(ClockoModel):
    """
    EmployeeShift model
    """
    ...
    objects = ClockoCompanyManager("employee_shift__company_id")
...
class EmployeeShiftSchedule(ClockoModel):
    """
    ...
    auto_punch_out_time = models.TimeField(
        ...
        help_text=_(
            "Time at which the Clocko will automatically check out the employee attendance if they forget."
        ),
    )
    company_id = models.ManyToManyField(Company, blank=True, verbose_name=_("Company"))

    objects = ClockoCompanyManager("shift_id__employee_shift__company_id")
...
class RotatingShift(ClockoModel):
    """
    RotatingShift model
    """
...
class RotatingShiftAssign(ClockoModel):
    """
...
class WorkTypeRequest(ClockoModel):
    """
...
class WorkTypeRequestComment(ClockoModel):
    """
...
class ShiftRequest(ClockoModel):
    """
    ShiftRequest model
    """
...
class ShiftRequestComment(ClockoModel):
    """
...
class ClockoMailTemplate(ClockoModel):
...
class DynamicEmailConfiguration(ClockoModel):
    """
...
class MultipleApprovalCondition(ClockoModel):
...
class Announcement(ClockoModel):
    """
...
class AnnouncementComment(ClockoModel):
    """
...
class DashboardEmployeeCharts(ClockoModel):
    from employee.models import Employee
...
class TrackLateComeEarlyOut(ClockoModel):
...
class CompanyLeaves(ClockoModel):
...
class PenaltyAccounts(ClockoModel):
    """
