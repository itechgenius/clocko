...
from Clocko_widgets.forms import ClockoForm, default_select_option_template
...
class AllowanceForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["specific_employees"] = ClockoMultiSelectField(
...
class GeneratePayslipForm(ClockoForm):
    """
    Form for Payslip
    """
...
class ReimbursementForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.request = getattr(Clocko_middlewares._thread_locals, "request", None)
        ...
        if type_ == "bonus_encashment":
            ...
            if not leave_type:
                ...
                if leave_type not in encashable:
                    ...
                    AvailableLeave = get_Clocko_model_class("leave", "availableleave")
