...
from base.forms import ModelForm as ClockoModelForm
...
from Clocko_widgets.widgets.select_widgets import ClockoMultiSelectWidget
...
class ObjectiveForm(BaseForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["assignees"] = ClockoMultiSelectField(
            queryset=Employee.objects.all(),
            widget=ClockoMultiSelectWidget(
        ...
        self.fields["managers"] = ClockoMultiSelectField(
            queryset=Employee.objects.all(),
            widget=ClockoMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
...
class FeedbackForm(ClockoModelForm):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        # # Clocko multi-select filter for subordinates
        # self.fields["subordinate_id"] = ClockoMultiSelectField(
        #     queryset=Employee.objects.all(),
        #     widget=ClockoMultiSelectWidget(
        #         filter_route_name="employee-widget-filter",
        #         filter_class=EmployeeFilter,
...
class PeriodForm(ClockoModelForm):
    """
...
class MeetingsForm(BaseForm):
    ...
    def as_p(self):
        ...
        """
        context = {"form": self}
        table_html = render_to_string("Clocko_form.html", context)
        return table_html
    ...
    def clean(self):
        ...
        if isinstance(self.fields["employee_id"], ClockoMultiSelectField):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["employee_id"] = ClockoMultiSelectField(
...
class BonusPointSettingForm(ClockoModelForm):
    """
...
class EmployeeBonusPointForm(ClockoModelForm):
    """
...
class EmployeeFeedbackForm(ClockoModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["others_id"] = ClockoMultiSelectField(
            queryset=Employee.objects.filter(employee_work_info__isnull=False),
            widget=ClockoMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
    ...
    def clean(self):
        cleaned_data = super().clean()
        if isinstance(self.fields["others_id"], ClockoMultiSelectField):
...
class BulkFeedbackForm(ClockoModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["employee_ids"] = ClockoMultiSelectField(
            queryset=Employee.objects.filter(employee_work_info__isnull=False),
            widget=ClockoMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
    ...
    def clean(self):
        cleaned_data = super().clean()
        if isinstance(self.fields["employee_ids"], ClockoMultiSelectField):
