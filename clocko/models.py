...
This module defines the abstract base model `ClockoModel` for the Clocko HRMS project.
The `ClockoModel` provides common fields and functionalities for other models within
...
class ClockoModel(models.Model):
    """
    An abstract base model that includes common fields and functionalities
    for models within the Clocko application.
    """
    ...
    Clocko_history = AuditlogHistoryField()
    ...
    def save(self, *args, **kwargs):
        ...
        super(ClockoModel, self).save(*args, **kwargs)
...
auditlog.register(ClockoModel, serialize_data=True)
